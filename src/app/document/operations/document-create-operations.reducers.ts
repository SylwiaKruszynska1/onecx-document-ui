...
export const documentCreateOperationsReducer = createReducer(
  ...
  on(DocumentCreateOperationsActions.requestDocumentUploadUrls, (state, { files }): DocumentCreateOperationsState => ({
    ...state,
  ...
  on(DocumentCreateOperationsActions.loadReferenceDataFailed, (): DocumentCreateOperationsState => ({
    ...initialState
  }))
)
