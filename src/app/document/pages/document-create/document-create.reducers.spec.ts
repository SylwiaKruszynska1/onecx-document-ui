...
describe('DocumentCreateReducer', () => {
  describe('enteredPage', () => {
    it('should set referenceDataLoading=true when types and mimeTypes are not yet loaded', () => {
      const state = reducers.documentCreateReducer(reducers.initialState, DocumentCreateActions.enteredPage())
    ...
    it('should set referenceDataLoading=false when referenceDataLoaded is already true', () => {
      ...
      const state = reducers.documentCreateReducer(preState, DocumentCreateActions.enteredPage())
  ...
  describe('submitClicked', () => {
    it('should set submitting=true', () => {
      const state = reducers.documentCreateReducer(reducers.initialState, DocumentCreateActions.submitClicked())
  ...
  describe('submitFinished', () => {
    it('should set submitting=false', () => {
      ...
      const state = reducers.documentCreateReducer(preState, DocumentCreateActions.submitFinished())
  ...
  describe('clearError', () => {
    it('should reset error to null', () => {
      ...
      const state = reducers.documentCreateReducer(preState, DocumentCreateActions.clearError())
      expect(state.error).toBeNull()
    })
  })
  ...
  describe('resetClicked', () => {
    it('should return to initial state', () => {
      ...
      const state = reducers.documentCreateReducer(dirtyState, DocumentCreateActions.resetClicked())
