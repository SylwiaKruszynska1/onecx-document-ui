...
describe('DocumentCreateComponent', () => {
  ...
  describe('onDetailsNext', () => {
    it('should dispatch detailsStepPatched and goToNextStep', () => {
      ...
      expect(dispatchSpy).toHaveBeenCalledWith(DocumentCreateActions.detailsStepPatched({ details: details as any }))
  ...
  describe('onAttachmentsBack', () => {
    it('should dispatch attachmentsStepPatched and goToPreviousStep', () => {
      ...
      expect(dispatchSpy).toHaveBeenCalledWith(DocumentCreateActions.attachmentsStepPatched({ attachments }))
      expect(dispatchSpy).toHaveBeenCalledWith(
  ...
  describe('onCharacteristicsSave', () => {
    it('should dispatch characteristicsStepPatched and submitClicked', () => {
      ...
      expect(dispatchSpy).toHaveBeenCalledWith(DocumentCreateActions.characteristicsStepPatched({ characteristics }))
      expect(dispatchSpy).toHaveBeenCalledWith(DocumentCreateActions.submitClicked())
    })
  })
})
