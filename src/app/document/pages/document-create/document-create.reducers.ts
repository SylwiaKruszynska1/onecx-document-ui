...
export const documentCreateReducer = createReducer(
  initialState,
  on(DocumentCreateActions.enteredPage, (state): DocumentCreateState => ({
    ...state,
    error: null,
    referenceDataLoading: !state.referenceDataLoaded
  })),
  on(DocumentCreateActions.goToNextStep, (state, { currentStep: step }): DocumentCreateState => {
  ...
  on(DocumentCreateActions.goToPreviousStep, (state, { currentStep: step }): DocumentCreateState => {
  ...
  on(DocumentCreateActions.detailsStepPatched, (state, { details }): DocumentCreateState => ({
    ...state,
    details: {
      ...state.details,
      ...details
  ...
  on(DocumentCreateActions.attachmentsStepPatched, (state, { attachments }): DocumentCreateState => ({
    ...state,
    attachments,
    error: null
  })),
  on(DocumentCreateActions.characteristicsStepPatched, (state, { characteristics }): DocumentCreateState => ({
    ...state,
    characteristics,
    error: null
  })),
  on(DocumentCreateActions.submitClicked, (state): DocumentCreateState => ({
    ...state,
    submitting: true,
    error: null
  })),
  on(DocumentCreateActions.submitFinished, (state): DocumentCreateState => ({
    ...state,
    submitting: false
  })),
  on(DocumentCreateActions.stepValidationFailed, (state, { error }): DocumentCreateState => ({
    ...state,
    error
  })),
  on(DocumentCreateActions.clearError, (state): DocumentCreateState => ({
    ...state,
    error: null
  })),
  on(DocumentCreateActions.resetClicked, (): DocumentCreateState => ({
    ...initialState
  })),
  on(DocumentCreateOperationsActions.ensureReferenceDataLoaded, (state): DocumentCreateState => ({
    ...state,
    referenceDataLoading: !state.referenceDataLoaded,
    error: null
  })),
  on(DocumentCreateOperationsActions.availableDocumentTypesReceived, (state): DocumentCreateState => ({
    ...state,
  ...
  on(DocumentCreateOperationsActions.availableMimeTypesReceived, (state): DocumentCreateState => ({
    ...state,
  ...
  on(DocumentCreateOperationsActions.loadReferenceDataFailed, (state, { error }): DocumentCreateState => ({
    ...state,
    referenceDataLoading: false,
    referenceDataLoaded: false,
    documentTypesReceived: false,
