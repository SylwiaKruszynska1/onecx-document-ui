...
describe('DocumentTypeSearchComponent', () => {
  ...
  describe('resultComponentStateChanged', () => {
    it('should dispatch resultComponentStateChanged when called', () => {
      ...
      expect(store.dispatch).toHaveBeenCalledWith(DocumentTypeSearchActions.resultComponentStateChanged(state))
    })
  })
  ...
  describe('searchHeaderComponentStateChanged', () => {
    it('should dispatch searchHeaderComponentStateChanged when called', () => {
      ...
      expect(store.dispatch).toHaveBeenCalledWith(DocumentTypeSearchActions.searchHeaderComponentStateChanged(state))
    })
  })
  ...
  describe('openCreateDialog', () => {
    it('should dispatch createDialogOpened and reset the form', () => {
      ...
      expect(store.dispatch).toHaveBeenCalledWith(DocumentTypeSearchActions.createDialogOpened())
  ...
  describe('closeDialog', () => {
    it('should dispatch dialogClosed and reset the form', () => {
      ...
      expect(store.dispatch).toHaveBeenCalledWith(DocumentTypeSearchActions.dialogClosed())
      expect(component.documentTypeFormGroup.get('name')?.value).toBeNull()
    })
  })
  ...
  describe('headerActions$', () => {
    it('should emit a single create action with the correct labelKey and permission', (done) => {
      component.headerActions$.subscribe((actions) => {
        ...
        expect(actions[1].labelKey).toBe('DOCUMENT_TYPE_SEARCH.HEADER_ACTIONS.CREATE')
    ...
    it('should navigate back when back action callback is invoked', (done) => {
      ...
      component.headerActions$.subscribe((actions) => {
        ...
        expect(dispatchSpy).toHaveBeenCalledWith(DocumentTypeSearchActions.navigateBackButtonClicked())
        done()
      })
    })
