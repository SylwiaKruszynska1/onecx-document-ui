...
export const documentDetailsReducer = createReducer(
  ...
  on(DocumentDetailsActions.documentDetailsLoadingFailed, (state: DocumentDetailsState): DocumentDetailsState => ({
    ...state,
    details: undefined,
    detailsLoadingIndicator: false,
    detailsLoaded: false
  })),
  on(DocumentDetailsActions.navigatedToDetailsPage, (): DocumentDetailsState => ({
    ...initialState,
    detailsLoadingIndicator: true
  })),
  on(DocumentDetailsActions.editButtonClicked, (state: DocumentDetailsState): DocumentDetailsState => ({
    ...state,
    editMode: true
  })),
  on(DocumentDetailsActions.saveButtonClicked, (state: DocumentDetailsState): DocumentDetailsState => ({
    ...state,
    isSubmitting: true
  })),
  on(
  ...
  on(DocumentDetailsActions.updateDocumentFailed, (state: DocumentDetailsState): DocumentDetailsState => ({
    ...state,
    isSubmitting: false
  })),
  on(
