 ...
 */
export function trimSpaces(event: ClipboardEvent, controlName: string, form: FormGroup, maxlength?: number) {
 ...
 */
export function noSpecialCharacters(control: AbstractControl): ValidationErrors | null {
  const pattern = /[\\/:*?<>|"]/
