...
import { localStorageSyncReducer, metaReducers, reducers } from './app.reducers'
      ...
      keys: [
        {
          document: [
            {
              search: ['chartVisible', 'resultComponentState', 'searchHeaderComponentState', 'diagramComponentState']
            }
          ]
        }
      ],
